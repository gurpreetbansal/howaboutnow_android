...
class SfBoldEditText : AppCompatEditText {
...
//            typeface = Typeface.createFromAsset(context.assets, "Poppins-Bold.otf")
//        } else {
        typeface = Typeface.createFromAsset(context.assets, "SFUIText-Bold.ttf")
//        }
    }
}