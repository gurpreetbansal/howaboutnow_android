        ...
        try {
            ...
            if (lat != 0.0 || lang != 0.0) {
                ...
                if (addresses.size > 0) {
                    ...
                    val json =
                        getJSONfromURL("http://maps.googleapis.com/maps/api/geocode/json?latlng=$lat,$lang&sensor=true")
                    try {
    ...
    fun getLatLngFromAddress(address: String): LatLng {
        ...
        try {
            ...
            if (addressList.size > 0)
                ...
                val `object` = getJSONfromURL(
                    "https://maps.googleapis.com/maps/api/geocode/json?address=" + address.replace(
                        " ",
                        "%20"
                    )
                )
                val jsonObject = `object`!!.getJSONArray("results").getJSONObject(0).getJSONObject("geometry")
...
//            }
    ...
    fun rotateMarker(
        ...
        roateMarkerRunnable = RoateMarkerRunnable(
            start,
            interpolator,
            duration.toFloat(),
            toRotation,
    ...
    private fun animateMarker(
        ...
        animateMarkerRunnable = AnimateMarkerRunnable(
            start,
            durationInMs,
            interpolator,
            oldMarker,
    ...
    private inner class AnimateMarkerRunnable internal constructor(
        internal var start: Long,
        internal var durationInMs: Float,
        internal var interpolator: Interpolator,
        internal var oldMarker: Marker,
        internal var latLngInterpolator: LatLngInterpolator,
        internal var startPosition: LatLng,
        internal var finalPosition: LatLng,
        internal var isCameraAnimate: Boolean,
        internal var googleMap: GoogleMap,
    ...
    private inner class RoateMarkerRunnable(
        internal var start: Long,
        internal var interpolator: Interpolator,
